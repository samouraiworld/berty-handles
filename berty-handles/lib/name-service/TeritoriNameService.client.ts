...
import {
  ...
  OwnerOfResponse,
  Approval,
  NftInfoResponseForMetadata,
  Metadata,
  AllOperatorsResponse,
  AllTokensResponse,
  AuthorizedCharactersResponse,
  BaseTokensResponse,
  Uint128,
  ContractInfoResponse,
  ExecuteMsg,
  SetAuthorizedCharactersMsg,
  UpdateSupportedDomainMsg,
  UpdateMintingFeesMsg,
  UpdateMetadataMsg,
  MintMsgForMetadata,
  GetFullPathResponse,
  GetParentIdResponse,
  GetParentInfoResponse,
  GetPathResponse,
  InstantiateMsg,
  IsContractResponse,
  IsSupportedDomainResponse,
  ListInfoByAliasResponse,
  UserInfo,
  ...
  NumTokensResponse,
  OperatorsResponse,
  PathsForTokenResponse,
  PathsResponse,
  PrimaryAliasResponse,
  QueryMsg,
  TokensResponse,
} from "./TeritoriNameService.types";
export interface TeritoriNameServiceReadOnlyInterface {
  ...
  addressOf: ({ tokenId }: { tokenId: string }) => Promise<AddressOfResponse>;
  allOperators: ({
    includeExpired,
    limit,
    owner,
  ...
  isContract: ({ tokenId }: { tokenId: string }) => Promise<IsContractResponse>;
  getParentId: ({
    tokenId,
  }: {
    tokenId: string;
  ...
  mintPrice: ({ tokenId }: { tokenId: string }) => Promise<MintPriceResponse>;
...
export class TeritoriNameServiceQueryClient
  implements TeritoriNameServiceReadOnlyInterface
{
...
export interface TeritoriNameServiceInterface
  extends TeritoriNameServiceReadOnlyInterface {
  contractAddress: string;
  sender: string;
...
export class TeritoriNameServiceClient
  extends TeritoriNameServiceQueryClient
  implements TeritoriNameServiceInterface
{
