        ...
        <section className={styles.content}>
          <div className={styles.contentContainer}>
              ...
              <div className={styles.leftContainer}>
                ...
                <div className={styles.bottomContainer}>
                  <div className={styles.textFrame}>
                    <p>
                      Creation of Wesh Network - we developed a new open-source P2P communication
                      protocol built on top of IPFS.{' '}
                    </p>
                  </div>
            ...
            <div className={`${styles.quarterContainer} ${styles.qrev}`}>
              <div className={styles.leftContainer}>
                <h2 className={styles.pinktext}>Ghost Launch Berty Messenger</h2>
                <div className={styles.bottomContainer}>
                  <div className={styles.textFrame}>
                    <p>
                      Berty Messenger, the 1st application of that uses the building blocks of Wesh
                      Network launches in App Store and Playstore:
                    </p>
                  </div>
            ...
            <div className={styles.quarterContainer}>
              <div className={styles.leftContainer}>
                <h2 className={styles.orangetext}>BETA - Stability Improvements</h2>
                <div className={styles.bottomContainer}>
                  <div className={styles.textFrame}>
                    <p>
                      We are currently working on stabilizing and increasing the performance of the
                      app.
                      <br />
                      <br />
            ...
            <div className={`${styles.quarterContainer} ${styles.qrev2}`}>
              <div className={styles.leftContainer}>
                <h2 className={styles.purpletext}>
                  Launch of Berty
                  <br />
                  Messenger v1.0
                </h2>
